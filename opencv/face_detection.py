        ...
        if pose_results is not None:
            ...
            if sway_detector.capturing:
                ...
                cv2.putText(display,
                            ...
                            (10, 145), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)
